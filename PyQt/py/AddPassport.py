...
# Form implementation generated from reading ui file 'PyQt\ui\AddPassport.ui'
#
...
class Ui_AddPassportWindow(object):
    def setupUi(self, AddPassportWindow):
        ...
        AddPassportWindow.resize(482, 410)
...
"}")
        ...
        self.label_series.setStyleSheet("QLabel{\n"
"    color:    #535353;\n"
"}")
...
"}")
        ...
        self.gridLayout_2.addWidget(self.label_number, 0, 2, 1, 1)
        self.edit_number = QtWidgets.QLineEdit(self.frame)
        self.edit_number.setObjectName("edit_number")
        self.gridLayout_2.addWidget(self.edit_number, 0, 4, 1, 1)
        ...
        self.label_identification_number.setStyleSheet("QLabel{\n"
"    color:    #535353;\n"
"}font-seize: 10px")
        ...
        self.gridLayout_2.addWidget(self.edit_identification_number, 1, 3, 1, 2)
...
"}")
        ...
        self.label_birth_date = QtWidgets.QLabel(self.frame)
        self.label_birth_date.setStyleSheet("QLabel{\n"
"    color:    #535353;\n"
"}")
        self.label_birth_date.setObjectName("label_birth_date")
        self.gridLayout_2.addWidget(self.label_birth_date, 3, 0, 1, 3)
        self.edit_birth_date = QtWidgets.QDateEdit(self.frame)
        self.edit_birth_date.setStyleSheet("QDateEdit{\n"
"    color:    black;\n"
"}")
        self.edit_birth_date.setObjectName("edit_birth_date")
        self.gridLayout_2.addWidget(self.edit_birth_date, 3, 4, 1, 1)
        self.label_issue_date = QtWidgets.QLabel(self.frame)
        self.label_issue_date.setStyleSheet("QLabel{\n"
"    color:    #535353;\n"
"}")
        self.label_issue_date.setObjectName("label_issue_date")
        self.gridLayout_2.addWidget(self.label_issue_date, 4, 0, 1, 2)
        self.edit_issue_date = QtWidgets.QDateEdit(self.frame)
        self.edit_issue_date.setStyleSheet("QDateEdit{\n"
"    color:    black;\n"
"}")
        self.edit_issue_date.setObjectName("edit_issue_date")
        self.gridLayout_2.addWidget(self.edit_issue_date, 4, 4, 1, 1)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.label_expiration_date, 5, 0, 1, 3)
        self.edit_expiration_date = QtWidgets.QDateEdit(self.frame)
        self.edit_expiration_date.setStyleSheet("QDateEdit{\n"
"    color:    black;\n"
"}")
        self.edit_expiration_date.setObjectName("edit_expiration_date")
        self.gridLayout_2.addWidget(self.edit_expiration_date, 5, 4, 1, 1)
...
"}")
    ...
    def retranslateUi(self, AddPassportWindow):
        ...
        self.label_birth_date.setText(_translate("AddPassportWindow", "Date of birth"))
...
if __name__ == "__main__":
    ...
    AddPassport = QtWidgets.QMainWindow()
    ui = Ui_AddPassportWindow()
    ui.setupUi(AddPassport)
    AddPassport.show()
    sys.exit(app.exec_())