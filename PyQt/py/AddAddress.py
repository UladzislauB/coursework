...
"}")
    ...
    def retranslateUi(self, AddAddressWindow):
        ...
        AddAddressWindow.setWindowTitle(_translate("AddAddressWindow", "Adress"))
        self.label_country.setText(_translate("AddAddressWindow", "Country"))
        self.lbl_city_typ.setText(_translate("AddAddressWindow", "City type"))
        self.label_city.setText(_translate("AddAddressWindow", "City"))
        self.label_region.setText(_translate("AddAddressWindow", "Region"))
        self.label_district.setText(_translate("AddAddressWindow", "District"))
        self.lbl_street_type.setText(_translate("AddAddressWindow", "Street type"))
        self.lbl_street.setText(_translate("AddAddressWindow", "Street"))
        self.lbl_house.setText(_translate("AddAddressWindow", "House"))
        self.lbl_building.setText(_translate("AddAddressWindow", "Building"))
        self.lbl_flat.setText(_translate("AddAddressWindow", "Flat"))
        self.btn_add.setText(_translate("AddAddressWindow", "Add"))
